-- Agrega parámetro p_admin_single_iva a rpc_venta_facturar.
-- Cuando es true (solo ADMIN), se omite la validación FALTA_FACTURA_EXENTO
-- para permitir cubrir IVA + EXENTO con una sola factura.

CREATE OR REPLACE FUNCTION "public"."rpc_venta_facturar"(
  "p_venta_id" bigint,
  "p_facturas" "jsonb",
  "p_admin_single_iva" boolean DEFAULT false
) RETURNS "jsonb"
