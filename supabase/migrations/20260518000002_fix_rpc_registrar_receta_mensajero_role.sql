-- Restaura MENSAJERO en rpc_venta_registrar_receta.
-- Una migración anterior lo había removido, dejando solo VENTAS y ADMIN.

CREATE OR REPLACE FUNCTION public.rpc_venta_registrar_receta(p_venta_id bigint, p_path text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
