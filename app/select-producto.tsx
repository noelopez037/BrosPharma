...
const styles = StyleSheet.create({
  ...
  switchText: { fontSize: Platform.OS === "web" ? 15 : 13, fontWeight: Platform.OS === "android" ? "500" : "600" },
  // (brand sheet handled by KeyboardAwareModal)
  modalBackdrop: { flex: 1 },
  backdrop: { flex: 1 },
  modalCard: { },
  modalTitle: { fontSize: Platform.OS === "web" ? 18 : 13, fontWeight: '700', marginBottom: 8 },
  modalItem: { padding: 12, borderTopWidth: 0 },
  modalItemText: { fontSize: Platform.OS === "web" ? 16 : 13 },
