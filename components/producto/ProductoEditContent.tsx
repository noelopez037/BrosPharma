// components/producto/ProductoEditContent.tsx
// Formulario de edición de producto como componente reutilizable (sin header ni navegación propia).
// Usado por producto-edit.tsx (nativo) y ProductoModalContent.tsx (web modal).
...
type Props = {
  productoId: number;
  onClose: () => void;
  /** Mostrar botón "← Atrás" inline. False cuando la ruta nativa ya provee header con back. */
  showBackButton?: boolean;
};

export function ProductoEditContent({ productoId, onClose, showBackButton = true }: Props) {
  const { colors } = useTheme();
  const insets = useSafeAreaInsets();
  const DONE_ID = "doneAccessoryEdit";
  ...
  if (loading) {
    return (
      ...
      >
        {showBackButton ? (
          <Pressable onPress={onClose} style={({ pressed }) => [s.inlineBack, pressed && { opacity: 0.7 }]}>
      ...
      >
        ...
        <View style={s.row2}>
          ...
          <Pressable
            ...
            style={({ pressed }) => [s.btnTint, pressed && { opacity: 0.75 }]}
          >
        ...
        <View style={s.switchRow}>
          ...
          <Switch
            ...
            thumbColor={Platform.OS === "android" ? (requiereReceta ? switchThumbOn : switchThumbOff) : undefined}
          />
        </View>
        ...
        <View style={s.switchRow}>
          ...
          <Switch
            ...
            trackColor={Platform.OS === "android" ? { false: switchTrackOff, true: switchTrackOn } : undefined}
            thumbColor={Platform.OS === "android" ? (tieneIva ? switchThumbOn : switchThumbOff) : undefined}
          />
        </View>
        ...
        <View style={s.switchRow}>
          ...
          <Switch
            ...
            trackColor={Platform.OS === "android" ? { false: switchTrackOff, true: switchTrackOn } : undefined}
            thumbColor={Platform.OS === "android" ? (activo ? switchThumbOn : switchThumbOff) : undefined}
          />
        </View>
