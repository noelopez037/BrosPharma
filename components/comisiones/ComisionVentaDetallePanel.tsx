...
const styles = (colors: any) =>
  StyleSheet.create({
    ...
    clienteNombre: { color: colors.text, fontSize: Platform.OS === "web" ? 18 : 15, fontWeight: "800" },
    ...
    v: { color: colors.text, fontSize: Platform.OS === "web" ? 15 : 13, fontWeight: "600", marginTop: 2 },
